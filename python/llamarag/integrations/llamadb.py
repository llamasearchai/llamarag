...
from llamarag.core.retrieval import Document, SearchResult, Retriever
...
class LlamaDBVectorStore:
    ...
    def add_documents(self, 
        ...
        for doc in documents:
            if doc.embedding is None:
                raise ValueError("Document missing embedding and no embedding model provided")
    ...
    def similarity_search(self, 
                          ...
                          k: int = 3) -> List[Tuple[str, Dict[str, Any], float]]:
        """
...
class LlamaDBRetriever(Retriever):
    ...
    def __init__(self, 
                 vector_store: LlamaDBVectorStore,
                 embedding_model):
        """
