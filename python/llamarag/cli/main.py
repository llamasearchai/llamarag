...
from llamarag.core.chunking import SentenceChunker, ParagraphChunker, FixedSizeChunker
...
def create_parser() -> argparse.ArgumentParser:
    ...
    embed_parser.add_argument(
        "--api-key",
        help="API key for the embedding service (if needed)"
    )
    
    # Retrieve command
    retrieve_parser = subparsers.add_parser("retrieve", help="Retrieve documents")
    retrieve_parser.add_argument("documents_file", help="JSON file with embedded documents")
    ...
    retrieve_parser.add_argument(
        "--query-file",
        help="File containing query text"
    )
    retrieve_parser.add_argument(
        "--top-k",
        type=int,
