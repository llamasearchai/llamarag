...
def generate_document_id(document: Document) -> str:
    ...
    metadata_str = json.dumps(document.metadata, sort_keys=True) if document.metadata else ""
...
def format_retrieval_results(results: List[SearchResult], include_metadata: bool = True) -> str:
    """
