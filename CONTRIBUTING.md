# Contributing to LlamaRag

Thank you for your interest in contributing to LlamaRag! This document provides guidelines and instructions for contributing to this project.
...
There are many ways to contribute to LlamaRag:
...
2. **Clone your fork**:
   ```bash
   git clone https://github.com/YOUR_USERNAME/llamarag.git
   cd llamarag
   ```

3. **Set up the upstream remote**:
   ```bash
   git remote add upstream https://github.com/llamasearchai/llamarag.git
   ```
...
By contributing to LlamaRag, you agree that your contributions will be licensed under the project's MIT License.
